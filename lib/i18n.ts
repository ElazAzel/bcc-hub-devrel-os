...
const values: Record<string, string> = {
  ...
  Meeting: "Встреча", Call: "Звонок", Teams: "Teams", Email: "Почта", Manager: "Руководитель", Strategy: "Стратегия", Personal: "Личное", Event: "Событие", Ambassador: "Амбассадор", Community: "Сообщество", Other: "Другое", Speaker: "Спикер", Partner: "Партнёр", Colleague: "Коллега", Media: "Медиа", Mentor: "Ментор", contact: "контакт", me: "я",
