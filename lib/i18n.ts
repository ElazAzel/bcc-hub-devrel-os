...
const values: Record<string, string> = {
  ...
  Meetup: "Митап", Hackathon: "Хакатон", Workshop: "Воркшоп", Conference: "Конференция", Townhall: "Общая встреча", Challenge: "Челлендж", Training: "Обучение", "Community Event": "Событие сообщества", LinkedIn: "LinkedIn", Telegram: "Telegram", Offline: "Офлайн", online: "Онлайн", offline: "Офлайн",
